...
void main() async {
  ...
  try {
    ...
    // Process lyrics lines and generate pinyin
    print('\nGenerating pinyin...');
    ...
    for (int i = 0; i < lyricsLines.length; i++) {
      ...
      String pinyin = '';
      try {
        // Use lpinyin to generate pinyin with tone marks
        final result = <String>[];
        for (int j = 0; j < line.length; j++) {
          ...
          if (char == ' ') {
            ...
            final charPinyin = PinyinHelper.getPinyinE(
              char,
              defPinyin: char,
        ...
        // If pinyin generation fails, leave it empty
        // It will be generated when the app loads the song
        print('Warning: Failed to generate pinyin for line $i: $e');
      }
